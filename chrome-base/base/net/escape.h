...
BASE_EXPORT std::string EscapeQueryParamValue(const std::string& text,
                                             bool use_plus);
...
BASE_EXPORT std::string EscapePath(const std::string& path);
...
// as %XX (hex).
BASE_EXPORT std::string EscapeUrlEncodedData(const std::string& path,
                                             bool use_plus);

// Escapes all non-ASCII input.
BASE_EXPORT std::string EscapeNonASCII(const std::string& input);
...
BASE_EXPORT std::string EscapeExternalHandlerValue(const std::string& text);
...
BASE_EXPORT std::string EscapeForHTML(const std::string& text);
BASE_EXPORT base::string16 EscapeForHTML(const base::string16& text);
...
BASE_EXPORT std::string UnescapeURLComponent(const std::string& escaped_text,
                                             UnescapeRule::Type rules);
BASE_EXPORT base::string16 UnescapeURLComponent(
...
// returned.
BASE_EXPORT base::string16 UnescapeAndDecodeUTF8URLComponent(
    const std::string& text,
    UnescapeRule::Type rules);
BASE_EXPORT base::string16 UnescapeAndDecodeUTF8URLComponentWithAdjustments(
    const std::string& text,
    UnescapeRule::Type rules,
...
// &lt; &gt; &amp; &quot; &#39;
BASE_EXPORT base::string16 UnescapeForHTML(const base::string16& text);
